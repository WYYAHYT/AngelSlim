...
## 📣Latest News
- [26/02/09] We have released HY-1.8B-2Bit, 2bit on-device large language model,[[Huggingface]]([https://arxiv.org/abs/2601.07892](https://huggingface.co/AngelSlim/HY-1.8B-2Bit)).
